...
// Paired with a .d.ts declaration so server/routes/mcp.ts gets proper tuple types at typecheck.
// Import in server/routes/mcp.ts as '../shared/country-bboxes.js'.
const jsLines = [
...
// Companion .d.ts so TypeScript knows the shape when server/routes/mcp.ts imports the .js
const dtsLines = [
  '// Auto-generated by scripts/generate-country-bboxes.cjs — do not edit manually',
