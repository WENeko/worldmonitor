...
const REQUIRED_REGISTRATIONS = Object.freeze([
  ...
  ['server/routes/mcp/registry/rpc-tools.ts', 'get_china_decision_signals', ROUTE, CANONICAL_KEY],
  ['server/gateway.ts', `'${ROUTE}': 'fast'`, `'${ROUTE}',`],
  ['shared/bootstrap-tier-keys.js', `chinaDecisionSignals: '${CANONICAL_KEY}'`],
  ['server/routes/_bootstrap-tier-keys.js', `chinaDecisionSignals: '${CANONICAL_KEY}'`],
